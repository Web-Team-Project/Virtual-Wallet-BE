...
async def add_funds(
    ...
    async def _add_funds():
        return await add_funds_to_wallet(
            db, wallet.amount, current_user, wallet.currency
        )
...
async def withdraw_funds(
    ...
    async def _withdraw_funds():
        return await withdraw_funds_from_wallet(
            db, current_user, wallet.amount, wallet.currency
        )
